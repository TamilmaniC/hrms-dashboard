      ...
      >
          ...
          InputProps={{
            startAdornment: (
              <InputAdornment position="start">
                <EmailIcon style={{ fontSize: "20px", color: "#666", marginBottom: "15px" }} />
              </InputAdornment>
            ),
        ...
        <TextField
          ...
          InputProps={{
            startAdornment: (
              <InputAdornment position="start">
                <LockIcon style={{ fontSize: "20px", color: "#666", marginBottom: "15px" }} />
              </InputAdornment>
            ),
            endAdornment: (
              <InputAdornment position="end">
                <IconButton
                  ...
                  edge="end"
                  style={{ marginBottom: "15px", color: "#666", backgroundColor: "#ffffff"}}
                >
